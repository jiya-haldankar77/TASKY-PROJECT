                ...
                <q-card flat bordered class="bg-white q-pa-md">
                  <div class="row items-center justify-between q-mb-md">
                    ...
                    <div class="row items-center q-gutter-x-sm">
                      ...
                      <q-btn size="sm" flat round icon="edit" color="primary" @click="showProgressDialog = true" />
                    </div>
                  </div>
                  ...
                  <q-list dense separator>
                    ...
                    <q-item class="q-py-md">
                      <q-item-section>
                        ...
                        <q-item-label class="text-weight-medium">{{ taskStore.currentTask.expected_effort || 0 }} hrs</q-item-label>
                      </q-item-section>
                    </q-item>
                    ...
                    <q-item class="q-py-md">
                      <q-item-section>
                        ...
                        <q-item-label class="text-weight-medium">{{ taskStore.currentTask.resources_needed || 1 }}</q-item-label>
                      </q-item-section>
                    </q-item>
                  </q-list>
                </q-card>
            ...
            <q-card flat bordered class="bg-white q-pa-md q-mb-md">
              ...
              <q-timeline color="primary">
                <template v-for="(item, index) in timelineItems" :key="index">
                  <q-timeline-entry :title="item.title" :subtitle="formatDateWithTime(item.date)" :icon="item.icon" :color="item.color">
                    <div class="row items-center q-mb-sm" v-if="item.user">
                      <q-avatar size="24px" class="q-mr-sm">
                        <img :src="item.user.avatar || `https://i.pravatar.cc/150?img=${item.user.id}`" />
                      </q-avatar>
                ...
                <div v-if="timelineItems.length === 0" class="text-caption text-grey text-center q-pa-md">No timeline events recorded.</div>
              </q-timeline>
            </q-card>
          </q-tab-panel>
          ...
          <q-tab-panel name="impact" class="q-pa-none">
            <q-card flat bordered class="bg-white q-pa-md">
              ...
              <div class="text-body2 text-grey-7 q-mb-md">
                Simulate changing the progress of this task to see its impact on the project schedule and workloads.
              </div>
              <q-btn outline color="primary" label="Run Impact Simulation" @click="runSimulation" :loading="simulationLoading" />
    ...
    <q-dialog v-model="showProgressDialog">
      <q-card style="width: 400px; max-width: 90vw;">
        ...
        <q-card-section class="q-pt-md">
          ...
          <q-input v-model="progressNote" type="textarea" outlined label="Add a note (optional)" rows="3" />
        </q-card-section>

        <q-card-actions align="right">
          <q-btn flat label="Cancel" color="primary" v-close-popup />
          <q-btn flat label="Save" color="primary" @click="saveProgress" :loading="savingProgress" />
        </q-card-actions>
      </q-card>
    </q-dialog>
