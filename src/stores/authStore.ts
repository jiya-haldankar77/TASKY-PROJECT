...
export const useAuthStore = defineStore('auth', () => {
  ...
  const registerEmployee = async (userData: Omit<User, 'id'> & { employeeId: string, inviteCode: string, password: string, professionalRoleOther?: string | null }) => {
    try {
  ...
  const updateProfile = async (userId: string, profileData: { firstName: string, surname: string, email: string, phone: string, avatar?: string }) => {
    try {
